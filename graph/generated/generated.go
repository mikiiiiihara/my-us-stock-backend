...
var sources = []*ast.Source{
	{Name: "../schema.graphqls", Input: `# GraphQLスキーマ定義 - graph/schema.graphqls
...
func (ec *executionContext) _Mutation_createUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*User)
	fc.Result = res
	return ec.marshalOUser2ᚖmyᚑusᚑstockᚑbackendᚋgraphᚋgeneratedᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOUser2ᚖmyᚑusᚑstockᚑbackendᚋgraphᚋgeneratedᚐUser(ctx context.Context, sel ast.SelectionSet, v *User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
